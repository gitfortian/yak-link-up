...
public final class FileRowConverters {
    ...
    public static DelimitedRowConverter createDelimited(FileSourceConfig config, TableSchema schema) {
    ...
    public static FileRowConverter createLine(FileSourceConfig config, TableSchema schema) {
        Objects.requireNonNull(config, "config must not be null");
        Objects.requireNonNull(schema, "schema must not be null");
    ...
    public static CSVFormat delimitedFormat(FileSourceConfig config) {
